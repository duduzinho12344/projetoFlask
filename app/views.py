...
def PostDetail(id):
    ...
    comentario2 = ClasseComentario.query.filter_by(useriddoparaguai=id).all()
    return render_template('post_detail.html',obj=obj,post=post, form=form, comentario = comentario, comentario2 = comentario2)
...
def contato_lista():
    if current_user.id == 7: return redirect(url_for('homepage'))
